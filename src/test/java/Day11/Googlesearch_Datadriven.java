...
for(int i=1;i<rowCount;i++){
            ...
            String Countriess = writableSheet.getCell(0, i).getContents();
            System.out.println("My values are " + Countriess);

            //navigate to google
            driver.navigate().to("https://www.google.com");
            //enter countries on my google search field
            Reusable_Actions.sendKeysMethod(driver, "//*[@name='q']", Countriess, "Search Field");
