...
public class UPS_ReusableMethod {
    public static void main(String[] args) {
        ...
        // Input the Tracking main method
        Reusable_Actions.sendKeysMethod(driver,"//*[@id='stApp_trackingNumber']","1111111","Entering Track");

        // Click on Track
        Reusable_Actions.clickMethod(driver,"//*[@id='stApp_btnTrack']","Track");
